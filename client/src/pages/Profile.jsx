  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <button
          disabled={loading}
          className="bg-slate-700 disabled:cursor-not-allowed text-white rounded-lg p-3 uppercase hover:opacity-95 disabled:opacity-80"
        >
      ...
      <p className="text-red-800 mt-5 font-semibold">
          ...
          {userListings.map((listing) => (
            ...
            >
              ...
              <div className="flex flex-col">
                <button className="text-red-800 uppercase font-semibold">
                  Delete
                </button>
                <button className="text-green-800 uppercase font-semibold">
                  Edit
                </button>
              </div>
            </div>
